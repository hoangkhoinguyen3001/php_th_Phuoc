...
<head>
    ...
    <title>Buổi 7 - Giỏ hàng (Cách 3: PDO MySQL)</title>
    <style>
    .table>tbody>tr>td {
...
<body>
    ...
    <div class="container">
        <h3>Giỏ hàng của admin (Cách 3: PDO MySQL)</h3>
        <?php
        $sql = "SELECT * FROM GioHang gh INNER JOIN SanPham sp ON gh.MaSP = sp.MaSP WHERE TenTaiKhoan = :tenTK";
        $params = array("tenTK" => "admin");
